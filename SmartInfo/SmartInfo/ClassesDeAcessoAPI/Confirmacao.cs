  ...
  public  class Confirmacao
    {
        ...
        /// <summary>
        /// Metodo Responsavel Para fazer a confrimação de um aluno
        /// </summary>
        public async Task<string> FazerConfirmacao(tb_confirmacao_Info tb_Confirmacao)
        {
          ...
          try
            {
                ...
                //}
                //else if (string.IsNullOrEmpty(Convert.ToString(tb_Matricula.Data_De_Nascimento)) == true)
                //{
                ...
                else
                {
                    ...
                    var json = JsonConvert.SerializeObject(tb_Confirmacao);
                    var content = new StringContent(json, Encoding.UTF8, "application/json");
                    using (var client = new HttpClient())
                    {
                        string URL = string.Concat(ConfigSystem.URLAPI, "/Confirmacao");
